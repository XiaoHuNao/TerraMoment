...
public class ModContextRegister {
    public static final DeferredRegister<MapCodec<? extends Moment>> MOMENT_CODEC = DeferredRegister.create(MomentRegistries.Keys.MOMENT_CODEC, TerraMoment.MODID);
