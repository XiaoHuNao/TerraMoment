...
public class GoblinArmyMoment extends DefaultMoment {
    public static final MapCodec<GoblinArmyMoment> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    ).apply(instance, GoblinArmyMoment::new));

    public GoblinArmyMoment() {
        super();
    }

    public GoblinArmyMoment(Optional<IBarRenderType> renderType, Optional<Area> area, Optional<MomentData> momentDataContext,
