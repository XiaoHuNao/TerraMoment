...
public class TorchGodMoment extends Moment {
    ...
    ).apply(instance, (mixTorchCount,multiAttackBarrage,renderType, area,
                       momentDataContext, tipSettingsContext, clientSettingsContext)
            -> new TorchGodMoment(mixTorchCount,multiAttackBarrage))
    );
    ...
    public TorchGodMoment(int mixTorchCount, RandomAmountContext multiAttackBarrage) {
